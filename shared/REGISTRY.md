...
| SLOW_QUERIES_LIMIT / SLOW_QUERIES_STALE_TIME_MS | constant | `features/admin-observability/constants/admin-observability.constants.ts` | features.md §13 |
| GET /api/admin/slow-queries | route-handler | `app/api/admin/slow-queries/route.ts` | infra.md §13 |
