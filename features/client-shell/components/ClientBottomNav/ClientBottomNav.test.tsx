...
describe("ClientBottomNav", () => {
  it("renders all 3 nav items", () => {
    renderWithProviders(<ClientBottomNav activePath="/map" />);
  ...
  it("marks active nav item with aria-current='page'", () => {
    renderWithProviders(<ClientBottomNav activePath="/orders" />);
  ...
  it("marks /profile as active when activePath is /profile", () => {
    renderWithProviders(<ClientBottomNav activePath="/profile" />);
