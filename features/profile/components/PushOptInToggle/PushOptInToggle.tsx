...
import type { PushOptInToggleProps } from "./PushOptInToggle.types";

const LABELS = Object.freeze({
  enable: "Activar notificaciones",
  enabled: "Notificaciones activas",
  denied: "Permiso denegado en el navegador",
  helperEnable: "Recibí avisos cuando tu pedido cambia de estado.",
  helperDenied: "Cambiá el permiso de notificaciones en los ajustes del navegador para activarlas.",
});
